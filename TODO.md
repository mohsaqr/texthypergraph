...
- [ ] **HyperGAT** (Ding et al. 2020): document-level hypergraphs
      (sentence + LDA-topic hyperedges, words as nodes) with dual
      node/edge attention — the expected answer to the 20NG/Ohsumed gap.
      Oracle: the official repo's model code (kaize0409), forward parity
      with fixed weights.
